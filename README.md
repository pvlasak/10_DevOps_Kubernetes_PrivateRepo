...
- to get authentication token from AWS resitory, following command can be used: *aws ecr get-login-password*. Authentication token is added to a ~/.docker/config.json file. 
